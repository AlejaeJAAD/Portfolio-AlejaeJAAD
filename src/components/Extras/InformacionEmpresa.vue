  ...
  export default {
    ...
    methods: {
      ...
      verificarCP() {
        console.log('Hola');
        return Axios.post(
          'https://api.copomex.com/query/info_cp/' +
            this.cp +
            '?token=47b8b142-c0dc-4767-b207-662d6e6064fa'
        ).then((res) => {
    ...
    created() {
      Axios.get(
        'https://api.copomex.com/query/get_estados?token=47b8b142-c0dc-4767-b207-662d6e6064fa'
      ).then((res) => {
